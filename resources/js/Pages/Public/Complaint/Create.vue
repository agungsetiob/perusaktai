            ...
            <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div v-if="form.errors.complaint_category_id" class="mt-1.5 flex items-center gap-1 text-xs font-medium text-red-600">
                    ...
                    <transition name="fade-slide">
                        <div v-if="!form.is_anonymous" class="space-y-5 rounded-xl border border-gray-100 bg-gray-50/30 p-5">
                            <h3 class="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Informasi Pelapor</h3>
                            ...
                            <div class="grid gap-5 sm:grid-cols-2">
                                <!-- No HP -->
                                <div>
                                    <label class="mb-1.5 block text-sm font-semibold text-gray-700">Nomor HP / WhatsApp</label>
                                    <input
                                        v-model="form.phone"
                                        type="text"
                                    ...
                                    >
                                    <div v-if="form.errors.phone" class="mt-1.5 text-xs font-medium text-red-600">⚠ {{ form.errors.phone }}</div>
                                </div>
                                ...
                                <div>
                                    ...
                                    >
                                    <div v-if="form.errors.nik" class="mt-1.5 text-xs font-medium text-red-600">⚠ {{ form.errors.nik }}</div>
                                </div>
                            </div>
                        </div>
                    </transition>
                    ...
                    <div>
                        ...
                        <div class="relative flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-300 bg-gray-50/50 px-6 py-5 text-center transition-all hover:bg-gray-50 hover:border-gray-400">
                            ...
                            <div class="flex text-sm text-gray-600">
                                <label class="relative cursor-pointer rounded-md font-semibold text-blue-600 focus-within:outline-none hover:text-blue-500">
                            ...
                            <p class="text-xs text-gray-400 mt-1">PNG, JPG, PDF hingga 5MB (Bisa pilih beberapa file)</p>

                            <!-- Mini Badge Total File Terpilih -->
                            <div v-if="form.attachments.length > 0" class="mt-3 inline-flex items-center gap-1.5 rounded-full bg-green-50 px-3 py-1 text-xs font-medium text-green-700 border border-green-200">
